...
<html lang="en">
	...
	<head>
		...
		<script src="app/controllers/admin-controller.js"></script>
		<script src="app/views/admin-view.js"></script>
	...
	<body>
		...
		<div class="currentLostItems">
			<div class="blueheader">
					<span>Lost and Found Administration</span>
			...
			<div class="main"><!--This div is for all of the lost itemss -->
				...
				<div class="lostitemcard hidden"> <!--This div is for each of the individiual lost item -->
					<div class="cardInfo">
					  ...
					  <div class="inner"><button type="individualCurrentLostItemBodyBtn" id="cardBtn">NOTIFY</button></div>
